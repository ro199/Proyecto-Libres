                ...
                <div class="container-fluid text-center">
                    <div class="row content">
                        ...
                        <div class="container" >
                            ...
                            $statement = 'select idobjeto_aprendizaje, usuario, nombre, descripcion,direcurl ,institucion, fechaCreacion, oa.id_usuario as id_usuario, ruta from objeto_aprendizaje oa join usuario u on oa.id_usuario=u.idUsuario where tipo_repo=1 and Publico="SI"';
