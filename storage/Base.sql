...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-07-2019 a las 00:18:12
...
INSERT INTO `objeto_aprendizaje` (`idobjeto_aprendizaje`, `nombre`, `descripcion`, `id_usuario`, `institucion`, `fechaCreacion`, `palabras_clave`, `tamanio`, `ruta`, `materia`, `tipo_repo`, `descarga`, `Privado`, `Publico`) VALUES
(2, 'github', 'Ayuda', 4, 'EPN', '2019-06-30 18:23:26', 'git', '813', '../../storage/github.txt', 'ALGORITMOS', 1, 0, 'htt', 'SI'),
(3, 'Patrones', 'Inteligencia de negocios', 4, 'EPN', '2019-06-30 18:35:49', 'Metodos', '1583', '../../storage/Patrones.txt', 'ALGORITMOS NUMERICOS', 1, 0, 'SI', 'SI'),
(4, 'LOLO', 'LO', 4, 'EPN', '2019-07-01 00:30:09', 'LO', '77807', '../../storage/LOLO.jpeg', 'ESTRUCTURA DE DATOS ', 1, 0, 'SI', NULL),
(5, 'uu', 'unasd', 4, 'EPN', '2019-07-01 00:37:58', 'ASDASD', '66179', '../../storage/uu.jpeg', 'GEOQUIMICA', 1, 0, 'SI', NULL),
(6, 'Software', 'Met', 4, 'EPN', '2019-07-01 03:15:11', 'xp', '2133', '../../storage/Software.txt', 'INGENIERÍA DE SOFTWARE II', 1, 0, 'SI', NULL),
(7, 'asdweasdsadasdasdasdasd', 'asdasdasdasdasdsa', 4, 'EPN', '2019-07-01 03:36:32', 'ew', '1339', '../../storage/asdweasdsadasdasdasdasd.txt', 'ALGORITMOS NUMERICOS', 1, 0, 'SI', NULL),
(8, 'XP', 'xp', 4, 'EPN', '2019-07-01 03:45:53', 'metodologia', '1270', '../../storage/XP.txt', 'INGENIERÍA DE SOFTWARE II', 1, 0, 'SI', NULL),
(9, 'Base de datos', 'Libres', 4, 'EPN', '2019-07-01 21:53:19', 'Server', '30098', '../../storage/Base+de+datos.sql', 'PROGRAMACIÓN II ', 1, 0, 'SI', NULL),
(10, 'Libres1', 'Parte del codigo', 2, 'EPN', '2019-07-01 23:26:14', 'Li', '13207', '../../storage/Libres1.php', 'BASES DE DATOS', 1, 0, 'SI', NULL),
(11, 'Test Driven', 'metodologia', 4, 'EPN', '2019-07-02 02:33:49', 'metodologia', '336', '../../storage/Test+Driven.txt', 'INGENIERÍA DE SOFTWARE II', 1, 0, 'SI', 'SI'),
(12, 'Wifi', 'metodologia', 4, 'EPN', '2019-07-02 19:54:58', 'wIFI', '34', '../../storage/Wifi.txt', 'ALGORITMOS NUMERICOS', 1, 0, 'SI', 'SI');
...
--
ALTER TABLE `objeto_aprendizaje`
  MODIFY `idobjeto_aprendizaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
